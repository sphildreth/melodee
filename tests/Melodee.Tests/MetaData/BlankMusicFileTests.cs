...
namespace Melodee.Tests.MetaData
{
    ...
    public class BlankMusicFileTests
    {
        ...
        public async Task Test_Generated_Vorbis_With_Tag_Reader()
        {
            ...
            string filePath = await BlankMusicFileGenerator.CreateMinimalVorbisFileAsync(_testOutputPath, metadata);
        ...
        public async Task Test_Generate_Multiple_File_Types()
        {
            ...
            List<string> files = await BlankMusicFileGenerator.CreateTestFileBatchAsync(_testOutputPath, metadata);
