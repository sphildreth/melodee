...
public static class SettingRegistry
{
    ...
    public const string ConversionSamplingRate = "formatting.samplingRate";    
    ...
    public const string MagicDoRemoveFeaturingArtistFromSongsArtist= "v.doRemoveFeaturingArtistFromSongsArtist";
    ...
    public const string ProcessingArtistNameReplacements = "processing.stagingDirectoryScanLimit";
    ...
    public const string ProcessingMinimumValidAlbumYear = "processing.minimumValidAlbumYear";
