...
/// <param name="FallbackGain">
///     An optional fallback gain that clients should apply when the corresponding gain value is
///     missing. (Can be computed from the Songs or exposed as an user setting.)
/// </param>
