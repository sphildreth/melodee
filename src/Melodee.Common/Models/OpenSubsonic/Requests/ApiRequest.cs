...
public record ApiRequest(string? Username, string? Version, string? Format, string? ApiKey, string? Password, string? Token, string? Salt, ApiRequestPlayer ApiRequestPlayer);
