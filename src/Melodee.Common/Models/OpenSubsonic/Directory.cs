...
public record Directory(Guid Id, string? Parent, string Name, string? Starred, int? UserRating, decimal AverageRating, long PlayCount, string? Played, Child[] Child);
