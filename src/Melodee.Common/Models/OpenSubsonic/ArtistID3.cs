...
) : IOpenSubsonicToXml
{
    ...
    {
        return
            $"<{nodeName ?? "artist"} id=\" {Id}\" name =\"{Name.ToSafeXmlString()} \" coverArt=\"{CoverArt}\" artistImageUrl=\"{ArtistImageUrl}\" albumCount=\"{AlbumCount}\" starred=\"{Starred}\" starredAt=\"{Starred}\" />";
    }
}
