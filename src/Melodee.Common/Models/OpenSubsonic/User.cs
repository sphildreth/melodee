...
public record User(string Username, bool AdminRole, string Email, bool StreamRole, bool ScrobblingEnabled, bool DownloadRole, bool ShareRole, bool JukeboxRole, string AvatarLastChanged) : IOpenSubsonicToXml
{
