...
/// <summary>
/// These take the DirectoryInfo for the directoy as the FileSystem should be light as possible, an example is there may be 10 images which should only have unique names in the same album directory.
/// </summary>
