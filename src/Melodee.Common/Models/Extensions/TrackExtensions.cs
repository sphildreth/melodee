...
public static class TrackExtensions
{
    ...
    public static string? ReleaseDate(this Track track) => track.MetaTagValue<string?>(MetaTagIdentifier.Date) ??
    ...
    public static DateTime? ReleaseDateValue(this Track track) => track.ReleaseDate().Nullify() == null ? null : DateTime.Parse(track.ReleaseDate()!); 
    ...
    public static string? Genre(this Track track) => track.MetaTagValue<string?>(MetaTagIdentifier.Genre);
