...
namespace Melodee.Common.Metadata.Mpeg
{
	...
	public class Id3V2Frame
	{
		...
		public Id3V2Frame()
		{
			...
			this.FTagAlterPreservation = false;
			this.FFileAlterPreservation = false;
			this.FReadOnly = false;
			this.FCompression= false;
			this.FEncryption = false;
			this.FGroupingIdentity = false;
			this.FUnsynchronisation = false;
			this.FDataLengthIndicator = false;
